...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#020B2D] border-t border-white/20 p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
      <p className="text-white/80 text-sm max-w-2xl">
        We use cookies to improve your experience. By continuing to use this site, you agree to our{' '}
        <Link href="/privacy-policy" className="text-[#dca958] hover:underline">Privacy Policy</Link>.
      </p>
